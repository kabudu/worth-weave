...
export function MarketDataDialog({ open, onClose, holdings, currencies, reportingCurrency }: Props) {
  ...
  return <dialog ref={dialogRef} className="market-dialog" onClose={onClose}>
    ...
    <section className="market-provider"><h3>Automatic US stock prices</h3><p>Connect Massive to fill missing US stock prices. Worthweave saves the key securely on this Mac and only contacts Massive when you refresh. Starter-plan prices may be delayed by 15 minutes.</p>
