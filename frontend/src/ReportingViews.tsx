...
import { capturePortfolioSnapshot, type ActivityEvent, type CurrencyOption, type Holding, type IncomeSummary, type PortfolioSnapshot, type ValuationSummary } from "./api";
...
export function PortfolioView({ holdings, valuation, snapshots, currencies, reportingCurrency }: PortfolioProps) {
